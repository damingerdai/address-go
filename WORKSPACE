...
go_repository(
    ...
    sum = "h1:+rhAzEzT3f4JtomfC371qB+0Ola2caSKcY69NUBZrRQ=",
    version = "v0.0.0-20190603091049-60506f45cf65",
)
...
go_repository(
    ...
    sum = "h1:Dho5nD6R3PcW2SH1or8vS0dszDaXRxIw55lBX7XiE5g=",
    version = "v0.0.0-20191224085550-c709ea063b76",
)
